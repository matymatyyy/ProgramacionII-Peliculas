        ...
        <div class="PanelRight">
            <div class="container py-4">
                ...
                <div class="card-body">
                    ...
                    <button class="btn btn-success" onclick="window.location.href='http://localhost:91/admin/panel/1'"><i class="bi bi-plus-circle"></i></button>
                    ...
                    <tbody>
                        ...
                        <td>
                            ...
                            <button class="btn btn-danger btn-sm" onclick="window.location.href='http://localhost:91/admin/panel/1'"><i class="bi bi-trash"></i></button>
                        </td>
                        </tr>
                        <?php } ?>
                    </tbody>
