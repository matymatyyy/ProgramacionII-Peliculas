                    ...
                    <div class="card-body">
                        <div class="d-flex justify-content-between mb-3">
                            <button class="btn btn-success"
                                onclick="window.location.href='http://localhost:91/admin/categorys/create'"><i
                                ...
                                <?php foreach ($data["category"] as $category) { ?>
                                    <tr>
                                        ...
                                        <td><button class="btn btn-success btn-sm"
                                                onclick="window.location.href='http://localhost:91/categorys/<?php echo $category->id() ?>'"><i
                                                    class="bi bi-eye"></i></button>
                                            <button class="btn btn-warning btn-sm"
                                                onclick="window.location.href='http://localhost:91/admin/categorys/update/<?php echo $category->id() ?>'"><i
                                                    class="bi bi-pencil"></i></button>
                                            <button class="btn btn-danger btn-sm"
                                                onclick="eliminarItem(<?php echo $category->id() ?>,2)"><i
                               ...
                               <?php echo "http://localhost:91/admin/panelCategory/" . $page - 1 ?>">Anterior</a></li>
                                    ...
                                    <?php if (count($data["category"]) > 5) { ?>
                                        <li class="page-item"><a class="page-link"
                                                href="<?php echo "http://localhost:91/admin/panelCategory/" . $page + 1 ?>">Siguiente</a>
                                        </li>
                                    <?php } ?>
                                </ul>
                            </nav>
